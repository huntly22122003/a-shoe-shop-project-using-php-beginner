                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <h4 class="card-title text-center font-weight-bold text-uppercase">đăng nhập</h4>
                        </div>
                        <div class="card-body" >
                            <form action="../php/DangNhap.php" method="POST" >
                                ...
                                <div class="d-grid gap-2"><button type="submit" class="btn btn-primary text-center">Đăng nhập</button></div>    
                            </form>
                            <div class="mt-3 text-center">
                                <a href="../html/LOSTMK.php">Quên mật khẩu?</a>
